...
class SwinTransformerUnet1_origin(nn.Layer):
    """
    ...
    def __init__(self,
        ...
        self._freeze_stages()
        self.oneconvone = layers.ConvBNReLU(768, 384, 1)
    ...
    def train(self):
        ...
        super(SwinTransformerUnet1_origin, self).train()
        self._freeze_stages()
...
class Decoder(nn.Layer):
    def __init__(self, align_corners, use_deconv=False):
        ...
        up_channels = [[384, 192], [192, 96], [96, 96]]
