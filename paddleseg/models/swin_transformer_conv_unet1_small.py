...
class SwinTransformer_conv_Unet1_small(nn.Layer):
    """
    ...
    def __init__(self,
        ...
        feat_channels=[]
        feat_channels.append(32)
        feat_channels.append(64)
        feat_channels.append(128)
    ...
    def forward(self, x):
        ...
        out, encoder_P= self.encode(out)
        encoder_P.pop()
        encoders.extend(encoder_P)
    ...
    def train(self):
        ...
        super(SwinTransformer_conv_Unet1_small, self).train()
        self._freeze_stages()
