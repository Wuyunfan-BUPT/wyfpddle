...
class SwinTransformerUnet1_small_deep(nn.Layer):
    """
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                dim=int(embed_dim * 2**i_layer) if i_layer!=3 else 512,
    ...
    def train(self):
        ...
        super(SwinTransformerUnet1_small_deep, self).train()
        self._freeze_stages()
...
class Decoder(nn.Layer):
    def __init__(self, align_corners, use_deconv=False):
        ...
        up_channels = [[512, 256], [256, 128], [128, 64], [64, 32], [32, 32]]
