...
class SwinTransformer_small_residual_PP(nn.Layer):
    """
    ...
    def __init__(self,
        ...
        feat_channels1 = [128, 256, 256]
        self.feat_channels = [32, 64, 128, 256, 256]
        self.feat_channels1 = feat_channels1

        # add a norm layer for each output
        for i_layer in out_indices:
            layer = norm_layer(feat_channels1[i_layer])
    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            if i in self.out_indices:
                ...
                out = x_out.reshape(
                    [-1, H, W, self.feat_channels1[i]]).transpose([0, 3, 1, 2])
                encoders.append(out)
    ...
    def train(self):
        ...
        super(SwinTransformer_small_residual_PP, self).train()
        self._freeze_stages()
